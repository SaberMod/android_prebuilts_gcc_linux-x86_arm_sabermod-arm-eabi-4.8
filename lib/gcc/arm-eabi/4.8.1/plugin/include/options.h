...
enum opt_code
{
  ...
  OPT_mpic_register_ = 1057,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1058,            /* -mpoke-function-name */
  OPT_msched_prolog = 1059,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1060,               /* -msingle-pic-base */
  /* OPT_msoft_float = 1061, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1062,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1063,                         /* -mthumb */
  OPT_mthumb_interwork = 1064,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1065,                  /* -mtls-dialect= */
  OPT_mtp_ = 1066,                           /* -mtp= */
  OPT_mtpcs_frame = 1067,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1068,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1069,                         /* -mtune= */
  OPT_munaligned_access = 1070,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1071,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1072,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1073,              /* -mword-relocations */
  OPT_mwords_little_endian = 1074,           /* -mwords-little-endian */
  OPT_n = 1075,                              /* -n */
  OPT_no_canonical_prefixes = 1076,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1077,              /* -no-integrated-cpp */
  OPT_nocpp = 1078,                          /* -nocpp */
  OPT_nodefaultlibs = 1079,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1080,                   /* -nostartfiles */
  OPT_nostdinc = 1081,                       /* -nostdinc */
  OPT_nostdinc__ = 1082,                     /* -nostdinc++ */
  OPT_nostdlib = 1083,                       /* -nostdlib */
  OPT_o = 1084,                              /* -o */
  OPT_p = 1085,                              /* -p */
  OPT_pass_exit_codes = 1086,                /* -pass-exit-codes */
  /* OPT_pedantic = 1087, */                 /* -pedantic */
  OPT_pedantic_errors = 1088,                /* -pedantic-errors */
  OPT_pg = 1089,                             /* -pg */
  OPT_pie = 1090,                            /* -pie */
  OPT_pipe = 1091,                           /* -pipe */
  OPT_print_file_name_ = 1092,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1093,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1094,          /* -print-multi-directory */
  OPT_print_multi_lib = 1095,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1096,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1097,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1098,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1099,               /* -print-prog-name= */
  OPT_print_search_dirs = 1100,              /* -print-search-dirs */
  OPT_print_sysroot = 1101,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1102,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1103,                          /* -quiet */
  OPT_r = 1104,                              /* -r */
  OPT_remap = 1105,                          /* -remap */
  OPT_s = 1106,                              /* -s */
  OPT_s_bc_abi = 1107,                       /* -s-bc-abi */
  OPT_save_temps = 1108,                     /* -save-temps */
  OPT_save_temps_ = 1109,                    /* -save-temps= */
  OPT_shared = 1110,                         /* -shared */
  OPT_shared_libgcc = 1111,                  /* -shared-libgcc */
  /* OPT_specs = 1112, */                    /* -specs */
  OPT_specs_ = 1113,                         /* -specs= */
  OPT_static = 1114,                         /* -static */
  OPT_static_libasan = 1115,                 /* -static-libasan */
  OPT_static_libgcc = 1116,                  /* -static-libgcc */
  OPT_static_libgcj = 1117,                  /* -static-libgcj */
  OPT_static_libgfortran = 1118,             /* -static-libgfortran */
  OPT_static_libgo = 1119,                   /* -static-libgo */
  OPT_static_libstdc__ = 1120,               /* -static-libstdc++ */
  OPT_static_libtsan = 1121,                 /* -static-libtsan */
  /* OPT_std_c__03 = 1122, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1123, */                /* -std=c++0x */
  OPT_std_c__11 = 1124,                      /* -std=c++11 */
  OPT_std_c__1y = 1125,                      /* -std=c++1y */
  OPT_std_c__98 = 1126,                      /* -std=c++98 */
  OPT_std_c11 = 1127,                        /* -std=c11 */
  /* OPT_std_c1x = 1128, */                  /* -std=c1x */
  /* OPT_std_c89 = 1129, */                  /* -std=c89 */
  OPT_std_c90 = 1130,                        /* -std=c90 */
  OPT_std_c99 = 1131,                        /* -std=c99 */
  /* OPT_std_c9x = 1132, */                  /* -std=c9x */
  OPT_std_f2003 = 1133,                      /* -std=f2003 */
  OPT_std_f2008 = 1134,                      /* -std=f2008 */
  OPT_std_f2008ts = 1135,                    /* -std=f2008ts */
  OPT_std_f95 = 1136,                        /* -std=f95 */
  OPT_std_gnu = 1137,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1138, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1139, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1140,                    /* -std=gnu++11 */
  OPT_std_gnu__1y = 1141,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1142,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1143,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1144, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1145, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1146,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1147,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1148, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1149, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1150,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1151, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1152, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1153, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1154,                     /* -std=legacy */
  OPT_symbolic = 1155,                       /* -symbolic */
  OPT_t = 1156,                              /* -t */
  OPT_time = 1157,                           /* -time */
  OPT_time_ = 1158,                          /* -time= */
  OPT_traditional = 1159,                    /* -traditional */
  OPT_traditional_cpp = 1160,                /* -traditional-cpp */
  OPT_trigraphs = 1161,                      /* -trigraphs */
  OPT_u = 1162,                              /* -u */
  OPT_undef = 1163,                          /* -undef */
  OPT_v = 1164,                              /* -v */
  OPT_version = 1165,                        /* -version */
  OPT_w = 1166,                              /* -w */
  OPT_wrapper = 1167,                        /* -wrapper */
  OPT_x = 1168,                              /* -x */
  OPT_z = 1169,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
